 ...
 */
public abstract class BenchmarkExperiment_V2_2_2 extends BenchmarkExperiment {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (Metric<?> metric : new Metric[] {  Metric.createPrecomputedLossMetric(1d),
            ...
            System.out.println("Average (20%):" + getAverageRiskQuality(BenchmarkSetup.getData(dataset), null, 5, metric));
            System.out.println("Average (9%):" + getAverageRiskQuality(BenchmarkSetup.getData(dataset), null, 11, metric));
            System.out.println("Individual (20%):" + getIndividualRiskQuality(BenchmarkSetup.getData(dataset), null, 5, metric));
            System.out.println("Individual (9%):" + getIndividualRiskQuality(BenchmarkSetup.getData(dataset), null, 11, metric));
    ...
    private static void analyze(BenchmarkDataset dataset, ARXCostBenefitConfiguration configuration, Metric<?> metric) throws IOException {
        ...
        BENCHMARK.addValue(QUALITY_COST_BENEFIT, getCostBenefitQuality2(data, configuration, metric));
